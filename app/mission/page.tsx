        ...
        <div className="w-full max-w-4xl">
          <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="relative space-y-8">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 rounded-xl p-4">
                    ...
                    <p className="text-white/80 text-sm">
                      Every image undergoes forensic examination including metadata analysis, compression pattern detection, 
                      color signature verification, and frequency domain analysis to ensure complete authenticity assessment.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-xl p-4">
                    <h3 className="text-lg font-semibold text-white mb-2">Real-Time Verification</h3>
                    <p className="text-white/80 text-sm">
                      Get instant results with our lightning-fast processing pipeline. Upload any image and receive 
                      a detailed authenticity report within seconds, complete with confidence scores and forensic evidence.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Analysis Process */}
              <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-2xl p-6 md:p-8">
                <h2 className="text-2xl font-bold text-white mb-6 text-center">How Our Analysis Works</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-sm font-bold text-white">1</div>
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">Image Upload & Validation</h3>
                        <p className="text-white/80 text-sm">Secure upload with format validation and size optimization for optimal analysis.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-sm font-bold text-white">2</div>
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">AI Feature Extraction</h3>
                        <p className="text-white/80 text-sm">Advanced algorithms analyze visual patterns, textures, and composition for authenticity markers.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-sm font-bold text-white">3</div>
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">Forensic Analysis</h3>
                        <p className="text-white/80 text-sm">Deep examination of metadata, compression artifacts, and digital signatures.</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-sm font-bold text-white">4</div>
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">Content Analysis</h3>
                        <p className="text-white/80 text-sm">AI-powered content understanding to identify scenes, objects, and context.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-sm font-bold text-white">5</div>
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">Authenticity Scoring</h3>
                        <p className="text-white/80 text-sm">Comprehensive scoring system providing confidence levels and detailed assessments.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-sm font-bold text-white">6</div>
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">Detailed Report</h3>
                        <p className="text-white/80 text-sm">Professional report with scene analysis, story context, and digital footprint verification.</p>
                      </div>
                    </div>
                  </div>
                </div>
